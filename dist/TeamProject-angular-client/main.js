...
var AdminDiscussionListComponent = /** @class */ (function () {
    ...
    AdminDiscussionListComponent.prototype.openCreateDiscussionTab = function () {
...
var BasicInformationComponent = /** @class */ (function () {
    function BasicInformationComponent(userService, providerService, router, data, modalService) {
        this.userService = userService;
        this.providerService = providerService;
        this.router = router;
        this.data = data;
    ...
    BasicInformationComponent.prototype.delete = function () {
        var _this = this;
...
var OrganizationSignUpComponent = /** @class */ (function () {
    function OrganizationSignUpComponent(providerService, router) {
        this.providerService = providerService;
        this.router = router;
    ...
    ProfileComponent.prototype.ngOnInit = function () {
        ...
        this.userService
            ...
            _this.eventService.findEventsForOrganizer(user._id)
                ...
                return _this.organizedEvents = events;
            });
            _this.enrollmentService.findEnrollmentsForAttendee(user._id)
                .then(function (events) {
                events.forEach(function (event) {
                ...
                return _this.attendedEvents = events;
            });
            _this.discussionService.findDiscussionForUser(user._id)
                .then(function (discussions) {
                _this.discussions = discussions;
...
var UserListComponent = /** @class */ (function () {
    function UserListComponent(userService, providerService, modalService) {
        this.userService = userService;
        this.providerService = providerService;
        this.modalService = modalService;
        this.attendees = [];
